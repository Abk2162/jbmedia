...
export const StaggeredMenu = ({
  ...
  // Scroll detection for header background blur
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    ...
    >
      ...
      <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
        {(() => {
          const raw = colors && colors.length ? colors.slice(0, 4) : ["#1F1A16", "#3A2A16", "#70330D", "#D4A22E"];
            ...
            {items && items.length ? (
              items.map((it, idx) => (
                <li className="sm-panel-itemWrap" key={it.label + idx}>
                  ...
                  >
                    {/* Signature Gold Wipe Fill */}
                    <span className="sm-panel-fill" aria-hidden="true" />

                    <span className="sm-panel-row">
