    ...
    <div className="min-h-screen pt-28 pb-20 px-4 sm:px-8 max-w-7xl mx-auto flex flex-col gap-20">
      ...
      <div className="flex flex-col gap-4 text-center sm:text-left">
        ...
        <h1 className="font-anton text-5xl sm:text-6xl lg:text-7xl uppercase tracking-tight text-foreground">
          OUR <span className="bg-gold-gradient bg-clip-text text-transparent">TEAM</span>
        </h1>
        <p className="font-barlow text-lg text-foreground/75 max-w-2xl">
          Meet the mentors, directors, domain leads, and creators driving JB Media's visual excellence across JBIET.
        </p>
      </div>
