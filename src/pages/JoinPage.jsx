  ...
  return (
    <div className="min-h-screen pt-28 pb-20 px-4 sm:px-8 max-w-5xl mx-auto flex flex-col gap-20">
      ...
      <div className="flex flex-col gap-4 text-center">
        ...
        <p className="font-barlow text-lg text-foreground/80 max-w-2xl mx-auto leading-relaxed">
          Be part of the family shaping JBIET's voice, culture, and visual presence. Choose your creative domain below and apply for our upcoming inductions.
        </p>
      </div>
